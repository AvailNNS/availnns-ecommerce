    ...
    navigator.geolocation.getCurrentPosition(
      async (position) => {
        try {
          ...
          // REVERSE GEOCIDING WITH OPENSTREETMAP
          ...
          const locationData = {
            ...
            area: address.suburb || address.town || "",
            road: address.road || "",
            latitude: String(lat),
    ...
    <div className="rounded-3xl border bg-white p-6 shadow-sm">
      <div className="mb-6 flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-zinc-500">Choose your delivery location</p>
        </div>
      </div>
      ...
      <button
        ...
        disabled={loading}
        className="flex w-full items-center justify-center gap-2 rounded-xl bg-black py-4 font-semibold text-white transition hover:opacity-90 disabled:opacity-50"
      >
        {loading ? (
          <>
      ...
      {location.latitude && (
        <div className="mt-6 space-y-4 rounded-2xl bg-green-50 p-5">
          ...
          <div className="grid gap-3 md:grid-cols-2">
            <div>
              ...
              <p className="font-semibold">{location.division || "-"}</p>
            </div>
            ...
            <div>
              <p className="text-xs text-zinc-500">Road</p>
              <p className="font-semibold">{location.road || "-"}</p>
            </div>
          </div>
          ...
          <a
            ...
            className="inline-flex items-center gap-2 rounded-xl bg-white px-4 py-3 font-semibold shadow transition hover:bg-zinc-50"
          >
