    ...
    <div className="rounded-3xl border bg-white p-6 shadow-sm">
      ...
      <div className="flex gap-3">
        ...
        <button
          type="button"
          onClick={applyCoupon}
          className="rounded-xl bg-black px-6 font-semibold text-white transition hover:bg-zinc-800"
        >
          Apply
        </button>
      </div>
      ...
      {applied && (
        <div className="mt-5 flex items-center gap-3 rounded-xl bg-green-50 p-4 text-green-700">
          ...
          <div>
            ...
            {/* ডিসকাউন্ট প্রাইস ডাইনামিক কারেন্সিতে কনভার্ট করা হলো */}
            <p className="text-sm">You saved {formatPrice(discount)}</p>
          </div>
        </div>
      )}
